document.addEventListener("DOMContentLoaded", function () {
    ...
    function processUserQuestion(inputText) {
        const recognizedOptions = {
            " Who are you ": "My Name is Siphiwe Nomcebo Mkhwanazi.",
    ...
    function startChat() {
        ...
        displayMessage("Hello, I'm Siphiwe Nomcebo Mkhwanazi the chatbot. How can I help you?", false, function () {
            showOptions([
                { text: "Who are you ", response: "My Name is Siphiwe Nomcebo Mkhwanazi" },
                ...
                { text: "What is your tech stack ", response: "Python ,Pandas ,Numpy, Power BI." },
                {
                    ...
                    followUp: [
                        { text: "Email", response: "You can contact me via email: nomcebo.mkhwanazi19@gmail.com" },
                        { text: "Personal Number", response: "You can contact me via Phone Number: 063 743 7046." },
                        { text: "LinkedIn", response: "You can reach me on LinkedIn: Siphiwe Nomcebo Mkhwanazi" }
                    ]
                }
            ]);
        });
